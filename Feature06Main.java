...
public class Feature06Main extends JFrame implements ActionListener {
    ...
    public Feature06Main(String chosen_word, int number_of_anagrams) {
    ...
    public static void main(String[] args) {
		...
		try{int num = Integer.parseInt(args[0]);
			...
			Feature06Main c = new Feature06Main(words.get(0),num);
		}
